        ...
        <CRow>
          <CCol>
            ...
            <CTab title="4. MITRE ATT&CK">
                ...
                <multiselect v-model="rule.tactics" placeholder="Select tags to apply to this detection" :taggable="true" tag-placeholder="Add new tactic" :options="tactics" :multiple="true" :close-on-select="false"/><br>
