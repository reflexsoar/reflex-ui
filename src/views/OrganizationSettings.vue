<template>
<CCol>
  <h2>Settings for {{mapOrgToName(uuid)}}<button type="button" aria-label="Close" class="close" onclick="window.open('https://github.com/reflexsoar/reflex-docs/blob/main/organizations/index.md')"><CIcon name='cil-book' size="lg"/></button></h2><br>
