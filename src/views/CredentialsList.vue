<template>
  <CRow>    
    <CCol col>
      <h2>Credentials<button type="button" class="kb" onclick="window.open('https://docs.reflexsoar.com/en/latest/credentials')"><CIcon name='cil-book' size="lg"/></button></h2><br>
