  ...
  data() {
    return {
      ...
      permission_map: {
        ...
        "Benchmarks": [
          'view_benchmarks',
          'create_benchmark_rule',
          'update_benchmark_rule',
          'view_benchmark_rulesets',
          'create_benchmark_ruleset',
          'update_benchmark_ruleset',
          'delete_benchmark_ruleset',
          'view_benchmark_exceptions',
          'create_benchmark_exclusion',
          'update_benchmark_exclusion',
          'delete_benchmark_exclusion',
        ],
